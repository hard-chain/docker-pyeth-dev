...
/usr/local/bin/pyethapp -m $MINE_PERCENT -l eth.chain:info,eth.chainservice:info,eth.validator:info --log-file /root/log/log.txt  --password /root/.config/pyethapp/password.txt -b $BOOTSTRAP_NODE run
